...
public class AstMapVisitor extends ExprMapVisitor implements AstVisitor<Ast, Expr>
{
    ...
    public Program visit(Program e)
    {
        ...
        return new Program(e.location, types, constants, e.contracts, functions, e.importedNodes, nodes, e.main);
    }
    ...
    {
        return new ContractImport(contractImport.location, contractImport.id, visitExprs(contractImport.inputs), visitExprs(contractImport.outputs));
    }
