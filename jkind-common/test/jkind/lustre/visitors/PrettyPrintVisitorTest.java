...
class PrettyPrintVisitorTest
{
    ...
    {
        return s.codePoints().filter(c -> !Character.isWhitespace(c)).collect(StringBuilder::new,
    ...
    void contractImportTest()
    {
        ...
        visitor.visit(new ContractImport("Spec", Collections.singletonList(LustreUtil.id("x")), Collections.singletonList(LustreUtil.id("y"))));
    ...
    void modeTest()
    {
        ...
        visitor = new PrettyPrintVisitor();
        visitor.visit(new Mode("m4", Collections.singletonList(LustreUtil.TRUE), Collections.singletonList(LustreUtil.TRUE)));
    ...
    {
        // raw strings require Java 12+
        String expected = "contract c() returns ();" +
                "let" +
                "guarantee true;" +
                "tel;";
    ...
    void ImportedNodeTest()
    {
        ...
        // raw strings require Java 12+
        expected = "node imported n() returns ();" +
                "(*@contract" +
                "guarantee true;" +
                "*)";
